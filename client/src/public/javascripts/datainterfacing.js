...
export let isDataRecording = false;
 ...
 */
export function createCache(name) { // eslint-disable-line no-unused-vars
 ...
 */
export function normalizePacket(input) {
  const { state } = input;
  let fixedPacket = input;
...
function createJSON(name) {
  console.log(`No file created: ${name}`);
 ...
 */
export function archiveData(name) {
